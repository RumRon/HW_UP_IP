...
#   y = paste(mklb.sf$commonpid,mklb.sf$price ), 
#   p = .60, list = FALSE)

# split data into training and test
model.training <- topredict_num
model.test <- challenge_num

## First model: All internal features, amenity features
model1 <- lm(price ~ ., data = topredict_num %>% 
...
```{r }
model2 <- lm(price ~ ., data = topredict_num %>% 
           dplyr::select(# internal features
                         ...
                         firestation_nn3,medical_nn1,medical_nn2)
)
