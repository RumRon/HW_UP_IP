...
#neighborhood
neighborhood <-
  st_read('http://maps.co.mecklenburg.nc.us/geoserver/postgis/ows?service=WFS&version=1.0.0&request=GetFeature&outputFormat=application%2Fjson&srsName=EPSG:4326&typeName=postgis:historicdistricts_py')%>%
  st_transform('EPSG:2264')
...
#
```{r comp_model, eval=FALSE, include=FALSE}
