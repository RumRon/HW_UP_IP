...
#school data
cmpd_school<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/CMS_Schools.geojson?token=GHSAT0AAAAAABZ2FKMPF5RHJNXTZFWAXYVEY2F2ZYA') %>%
  st_transform('EPSG:2264')

# firestation
cmpd_firestation<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/CFD_FireStations.geojson?token=GHSAT0AAAAAABZ2FKMP4NHP7HW62QTGJT5UY2F2ZDQ') %>%
  st_transform('EPSG:2264')

# church
cmpd_church<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/Churches.geojson?token=GHSAT0AAAAAABZ2FKMPUGX35HL33DKC6VTGY2F2Z6A') %>%
  st_transform('EPSG:2264')
...
# park
cmpd_park<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/Park_Locations.geojson?token=GHSAT0AAAAAABZ2FKMPPLAMMKRVPPAKQL3SY2F22OA') %>%
  st_transform('EPSG:2264')
# police
cmpd_police<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/CMPD_Police_Offices.geojson?token=GHSAT0AAAAAABZ2FKMPI3UEICX237BDDPW2Y2F2ZRQ') %>%
  st_transform('EPSG:2264')

# bus
cmpd_busstation<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/CATS_BusStops.geojson?token=GHSAT0AAAAAABZ2FKMPZ2ETXW6SHQFIIQPOY2F2Y2Q') %>%
  st_transform('EPSG:2264')
...
bart_Buffers <-
  rbind(
    st_buffer(bus.sf, 2640) %>% # 0.25mile = 1320 ft is an acceptable walking distance
