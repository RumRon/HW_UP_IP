...
relatively higher age, lower income, lower daily internet usage, lower time on FB

**What are some of the ways in which clickers and non-clickers are different?**
people with more experience of ad (more internet usage and more time on FB) tend not to click? 
...
> AIC could be comparable use some dataseta and features, smaller number the better  <br />
...
advertisingModel <- glm(clickNumeric ~ .,
                  data=advertisingTrain %>% dplyr::select(-Country, -Timestamp, -click, -userTimeFrame,
                                                          -Fashion_FB_Group), 
                  #select(Age, Area_Income, Male, Country, clickNunmeric) McFadden: 0.53
                  family="binomial" (link="logit"))
...
**False Positive:** We predicted a click and it wasn't a click IRL

**True Negative:** We predicted no click and it wasn't a click IRL

**False Negative:** We predicted no click and it was a click IRL
