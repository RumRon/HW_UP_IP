...
buffer_final <- buffer_info %>%
  group_by(Name,year) %>%
  summarize("MedRent" = mean(MedRent),
...
ggplot() + 
  ...
  geom_sf(data = centers, aes(size = TotalPop,fill = TotalPop,alpha = 1),shape = 21, 
          show.legend = "point") + 
  labs(title = "Graduated Symbol Maps of Population within 0.5 Nile of Each Transit Station", 
       subtitle = "San Francisco, CA",
       caption="Figure 5.1") +
  guides(alpha = FALSE)+
  guides(size = FALSE)+
...
ggplot() + 
  ...
  geom_sf(data = tracts09, fill = "white") + 
  geom_sf(data = tracts20, fill = "white") + 
  geom_sf(data = centers, aes(size = MedRent,fill = MedRent,alpha = 0.1), shape = 21, 
          show.legend = "point") + 
  labs(title = "Graduated Symbol Maps of Rent within 0.5 Nile of Each Transit Station", 
       subtitle = "San Francisco, CA",
       caption="Figure 5.2") +
  guides(alpha = FALSE)+
  guides(size = FALSE)+
