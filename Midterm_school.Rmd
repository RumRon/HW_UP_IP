...
```{r}
try.data<-
  st_read("https://raw.githubusercontent.com/RumRon/MUSA_508/blob/main/Midterm/landfills/Landfills.shp")%>%
...
#school data
cmpd_school<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/CMS_Schools.geojson?token=GHSAT0AAAAAABY2SI6UURYASKZWEMKWCTYEY2ELSJA') %>%
  st_transform('EPSG:2264')
