  ...
  mklb.sf %>% 
    mutate(
       ...
       police_nn2 = nn_function(st_coordinates(mklb.sf), 
                              st_coordinates(cmpd_police), k = 2),
       police_nn3 = nn_function(st_coordinates(mklb.sf), 
                              st_coordinates(cmpd_police), k = 3))  
