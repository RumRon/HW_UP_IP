...
#school data
cmpd_school<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/CMS_Schools.geojson?token=GHSAT0AAAAAABY2SI6UZW5WHHXYTA4QIQU6Y2EQD6Q') %>%
  st_transform('EPSG:2264')

#CATS_BusStops.geojson
cmpd_bustation<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/CATS_BusStops.geojson?token=GHSAT0AAAAAABY2SI6VJEE4E5II6ZEGLAUYY2EPJXQ') %>%
  st_transform('EPSG:2264')

# police office
cmpd_policeoffice<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/CMPD_Police_Offices.geojson?token=GHSAT0AAAAAABY2SI6VEVIMCMFY5JCPVR3GY2EQC6A') %>%
  st_transform('EPSG:2264')

# church
cmpd_church<-
  st_read('https://raw.githubusercontent.com/RumRon/MUSA_508/main/Midterm/geojson/Churches.geojson?token=GHSAT0AAAAAABY2SI6UIAMFFOKHQ72OCC6OY2EQE7Q') %>%
  st_transform('EPSG:2264')
...
```{r}
a <- nn_function(st_coordinates(topredict), cmpd_school.sf, k = 1 )
```
